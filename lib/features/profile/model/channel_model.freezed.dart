...
class _$ChannelImpl implements _Channel {
  const _$ChannelImpl({
    ...
    required final List<VideoPost> videos,
  }) : _videos = videos;
  ...
  @override
  String toString() {
    return 'Channel(id: $id, title: $title, description: $description, avatarUrl: $avatarUrl, subscriberCount: $subscriberCount, videos: $videos)';
  }
